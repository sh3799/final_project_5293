...
American<- filter(res_columbia, res_columbia$`CUISINE DESCRIPTION` =="American") %>% distinct(DBA)%>% paste(sep=" ")%>%str_remove()
American
# Load
library("tm")
library("SnowballC")
...
library("XML")
library("rquery")
res1<-rquery.wordcloud(American, type ="file", lang = "english")
